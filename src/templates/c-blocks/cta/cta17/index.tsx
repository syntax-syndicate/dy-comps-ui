  ...
  return (
    <section className="py-32">
      <div className="container">
        <div className='flex items-center justify-center rounded-2xl border bg-[url("https://placehold.co/900/EBEDED/C3C9C9?text=O&font=poppins.svg")] bg-cover bg-center px-8 py-20 text-center md:p-20'>
