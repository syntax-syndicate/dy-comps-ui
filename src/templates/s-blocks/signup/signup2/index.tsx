...
export default function SignupPage() {
  ...
  return (
    <section className="min-h-screen bg-gradient-to-br from-background to-secondary/20 py-32">
        ...
        <Card className="mx-auto w-full max-w-sm overflow-hidden">
          ...
          <CardHeader className="space-y-1">
            <div className="flex justify-center">
              <div className="relative">
                <Image
                  src="/logo.svg"
                  alt="logo"
                  className="mb-4 h-16 w-auto animate-pulse"
                  width={100}
                  height={100}
                />
              </div>
            ...
            <CardDescription className="text-center">
              Sign up in less than 2 minutes and explore.
            </CardDescription>
          </CardHeader>
          <CardContent>
