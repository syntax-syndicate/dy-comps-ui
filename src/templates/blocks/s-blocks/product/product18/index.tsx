      ...
      <div className="grid gap-8 lg:grid-cols-[1fr_1fr]">
        ...
        <div className="space-y-8">
          <div className="space-y-4">
            <h1 className="text-4xl font-bold">Chelsea Single Seater</h1>
            <div className="flex items-center gap-1">
              {Array.from({ length: 4 }).map((_, i) => (
                <Star key={i} className="size-6 fill-primary text-primary" />
              ))}
              <Star className="size-6 fill-muted stroke-muted-foreground" />
              <span className="ml-2 text-muted-foreground">(124 reviews)</span>
            </div>
            <p className="text-3xl font-semibold">$599.99</p>
          </div>
              ...
              <Card>
                <CardContent className="p-6">
                  <p className="text-muted-foreground">
                    The Chelsea Single Seater chair uses a safe, environmentally
                    friendly filler. The special properties make the furniture
                    not only soft but also comfortable. Made of Mat - the most
                    popular furniture fabric, pleasant to touch while being
                    durable and reliable. This chair is perfect for modern
                    living spaces, offering both style and comfort. Its sleek
                    design and high-quality materials ensure longevity and a
