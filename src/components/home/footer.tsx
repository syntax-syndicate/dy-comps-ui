...
function Footer() {
  return (
    <footer
      id="dy-footer"
      className="relative m-2 mt-8 flex flex-col gap-8 overflow-hidden rounded-3xl border-t bg-accent p-6 !pb-0 text-accent-foreground md:m-4 md:p-10 lg:m-8 lg:p-16"
    >
